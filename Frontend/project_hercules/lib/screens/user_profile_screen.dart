...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<User> updateUser(
    ...
    final http.Response response = await http.patch(
      Uri.parse("http://localhost:5000/personalInfo/updateUserById/" +
          widget.userId),
  ...
  Future<User> updateUserPassword(String password) async {
    final http.Response response = await http.patch(
      Uri.parse(
          "http://localhost:5000/personalInfo//updateUserPasswordById/" +
              widget.userId),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
  ...
  Future<User> deleteUser() async {
    final http.Response response = await http.delete(
      Uri.parse("http://localhost:5000/personalInfo/deleteUserById/" +
          widget.userId),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
