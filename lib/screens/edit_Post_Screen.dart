...
class EditPostScreen extends StatefulWidget {
  ...
  const EditPostScreen(
      {required this.usernamePost, required this.userId, required this.postId});
  @override
...
class _EditPostScreenState extends State<EditPostScreen> {
  ...
  Future<Post> getRequest() async {
    final String url =
        "https://postifybackend.onrender.com/postInfo/getPostById/" +
            widget.postId;
  ...
  Future<Post> deletePost() async {
    final http.Response response = await http.delete(
      Uri.parse("https://postifybackend.onrender.com/postInfo/deletePostById/" +
          widget.postId),
  ...
  Future<Post> updatePost(
    ...
    final http.Response response = await http.patch(
      Uri.parse("https://postifybackend.onrender.com/postInfo/updatePostById/" +
          widget.postId),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception("Post UPDATING Failed");
  }
